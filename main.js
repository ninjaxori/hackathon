...
var FakeBackendInterceptor = /** @class */ (function () {
    ...
    FakeBackendInterceptor.prototype.intercept = function (request, next) {
        var users = [
            { id: 1, util: 80, username: 'goyal_m', password: '1234', firstName: 'Mohit', lastName: 'Goyal', role: _models__WEBPACK_IMPORTED_MODULE_4__["Role"].Admin },
            { id: 2, util: 75, username: 'jain_r', password: '1234', firstName: 'Rahul', lastName: 'Jain', role: _models__WEBPACK_IMPORTED_MODULE_4__["Role"].User }
        ];
...
var AdminComponent = /** @class */ (function () {
    function AdminComponent(userService, authenticationService, httpService) {
        ...
        this.chartData = [
            {
                data: [], label: 'Employee Billable Hours'
            }
        ];
        this.colors = [
            {
            ...
            },
            {
                ...
                backgroundColor: 'rgba(55, 125, 234, 0.6)'
            }
        ];
        ...
        this.options = [
            ...
            new _models_teams__WEBPACK_IMPORTED_MODULE_3__["Teams"]("DBA", 'KPMG DB')
        ];
    ...
    AdminComponent.prototype.loadbillable = function () {
        ...
        console.log(this.url + this.optionSelected);
    };
    AdminComponent.prototype.ngOnInit = function () {
        //            this.httpService.get(this.url+'Dev').subscribe(
        //     data => {
...
/* harmony import */ var _respoool_respoool_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./respoool/respoool.component */ "./src/app/respoool/respoool.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [
                ...
                _respoool_respoool_component__WEBPACK_IMPORTED_MODULE_15__["RespooolComponent"],
            ],
            providers: [
...
module.exports = "<div style=\"text-align:center \">\n<p style=\"display: inline-block \">Pie Chart representation of total hours</p>\n</div >\n<div>\n  \n  <ngx-spinner\n  \n  bdColor=\"rgba(51,51,51,0.8)\"\n  size=\"medium\"\n  color=\"#fff\"\n  type=\"ball-scale-multiple\">\n\n  <p style=\"font-size: 20px; color: white\">Loading...</p>\n</ngx-spinner>\n        <!-- <div>\n            <canvas baseChart\n                [data]= \"pieChartData\"\n                [labels]=\"pieChartLebels\"\n                [chartType]= \"pieChartType\">\n            </canvas>\n              </div> -->\n              <div>\n                <canvas\n                    baseChart\n                    [chartType]=\"'pie'\"\n                    [datasets]=\"pieChartData\"\n                    [labels]=\"pieChartLabels\"\n                    [options]=\"pieChartOptions\"\n                    [legend]=\"true\"\n                    [colors]=\"pieChartColor\"></canvas>\n              </div>\n            <p></p>\n\n            <p>\n              </p>\n              <p>\n            </p>\n              <div style=\"text-align: center;\" class=\"card\">\n                <div style=\"align-content: right;\" style=\"align-content: right;\"  class=\"card-body\">\n                  <a style=\"align-content: right;\">Your Utilization is </a>{{userFromApi.util}}%\n                </div>\n              </div>\n</div>"
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(userService, authenticationService, httpService, spinner) {
        this.userService = userService;
        this.authenticationService = authenticationService;
        this.httpService = httpService;
        ...
        this.pieChartLabels = ['Daily Task', 'Training', 'Leave'];
        this.pieChartColor = [
            {
                backgroundColor: ['rgba(30, 169, 224, 0.8)',
                    'rgba(255,165,0,0.9)',
    ...
    HomeComponent.prototype.ngOnInit = function () {
        ...
        console.log(this.userFromApi.util);
    };
...
module.exports = "<div class=\"jumbotron\">\n  <h1 style=\"text-align: center;\"  class=\"display-4\">Coming Soon!</h1>\n</div>"
